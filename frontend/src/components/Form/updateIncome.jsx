...
function UpdateForm({ openUpdate, handleCloseUpdate, income }) {

    const { updateIncome, fetchIncome } = useGlobalContext()
    const initialState = {
        title: "",
        amount: "",
        category: "",
    ...
    useEffect(() => {
        setInputState(income || initialState);
      }, [income]);
        ...
        >
            <Box className='flex justify-center items-center'>
                <div className='w-full py-8 px-4 sm:px-10 border flexflex-col justify-center items-center my-5 mt-14 rounded-md bg-secondary' onSubmit={handleSubmit}>
                    <h1 className='text-3xl font-extrabold mb-5'>Update Income</h1>
                    {showAlert && <SimpleAlert message="Income updated successfully!" onClose={closeAlert} />}
